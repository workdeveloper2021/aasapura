...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 #1abc9c; font-weight: normal; text-decoration: none" target="_blank" title="">
                                                                    <a class="" href="https://www.lingoapp.com/" style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #1abc9c; font-weight: normal; text-decoration: none" target="_blank" title="">
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 font-family: 'Asap', Helvetica, sans-serif;" valign="middle">
                                                                                <a class="mcnButton"
                                                                                    href="{{ url('reset-password/' . $user->remember_token) }}"
                                                                                    style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; display: block; color: #1abc9c;
 ...
 #FFFFFF; text-transform:uppercase;    padding-top: 24px;
    padding-right: 48px;
    padding-bottom: 24px;
    padding-left: 48px;" target="_blank" title="Review Lingo kit
