<?php
    ...
    $metatitle = $row->meta_title ? $row->meta_title : 'not found';
    $metatags = $row->meta_tag ? $row->meta_tag : 'not found';
    $desc = $row->meta_description ? $row->meta_description : 'not found';
                    ...
                    <article class="entry">
                        <figure class="entry-media">
                            <a href="javascript:void(0)">
                                <img src="{{ url('uploads')}}/{{ $row->image }}" alt="{{ $row->title }}" />
                            </a>
                        </figure>
                        <!-- End .entry-media -->
                        ...
                        <div class="entry-body">
                            <div class="entry-meta">
                                <span class="entry-author">
                                    by <a href="javascript:void(0)">{{ $row->writer_name }}</a>
                                </span>
                                <span class="meta-separator">|</span>
                                <a href="javascript:void(0)">{{ $row->created_at->format('M d, Y') }}</a>
                            </div>
                            <!-- End .entry-meta -->
                            ...
                            <div class="entry-cats">
                                in <a href="javascript:void(0)">{{ $category->name }}</a>,
                            </div>
                            <!-- End .entry-cats -->
