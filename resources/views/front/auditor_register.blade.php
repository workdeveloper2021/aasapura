...
<main class="main">
    <div class="page-header text-center"
        ...
        <div class="container">
            <h1 class="page-title text-white">Auditor Registeration</h1>
        </div>
        <!-- End .container -->
    </div>
    <!-- End .page-header -->
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea required name="address_2" id="" rows="2" style="min-height: auto"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" required name="gst_number" value="{{ old('gst_number') }}"
                                        class="form-control">
                                    @error('gst_number')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" required name="owner_first_name" value="{{ old('owner_first_name') }}"
                                        class="form-control">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" required name="owner_last_name" value="{{ old('owner_last_name') }}"
                                        class="form-control">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" required name="pincode" value="{{ old('pincode') }}" class="form-control">
                                    @error('pincode')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label>Photo of business location <span class="text-danger">(Max 2 Mb allowed)</span></label>
                                    <input type="file" required name="business_location_image" class="form-control">
                                ...
                                <div class="col-md-12">
                                    <label>Photo of owner/manager <span class="text-danger">(Max 2 Mb allowed)</span></label>
                                    <input type="file" required name="owner_image" class="form-control">
                                    @error('owner_image')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
