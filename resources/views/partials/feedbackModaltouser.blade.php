    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="">
                   <div class="col-12">
                            <form action="/submit-rating-to-customer" method="post" class="mt-2 pb-3 px-3">
                                @csrf
                                <h5 class="mb-0">Give Review</h5>
                                <input type="text" name="product_id" value="{{ $product->id ?? "" }}" id=""  hidden>
                                <input type="text" name="user_id" value="{{ $user_id ?? "" }}" id=""  hidden>
                                <input type="text" name="order_id" value="{{ $orderdata->id ?? "" }}" id=""  hidden>
