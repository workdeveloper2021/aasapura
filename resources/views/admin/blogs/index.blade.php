            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="/admin/blogs/create" class="btn  btn-primary mt-3">Create Blog</a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('change.status', ['table' => 'blogs', 'id' => $value->id]) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('deleterow', ['table' => 'blogs', 'id' => $value->id, 'image' => $image]) }}"
