@section('title','Dashboard - Blogs Create')
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <textarea name="short_description" id="" class="form-control" cols="30" rows="3"></textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="writer_name"  class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                            @error('writer_name')
                                        <div class="error_text">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" name="description" row="10"></textarea>
                                        @error('description')
                                        <div class="error_text">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_tag" class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                            @error('meta_tag')
                                            <div class="error_text">{{ $message }}</div>
                                            @enderror
