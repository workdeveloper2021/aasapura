            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        --}}
                        <a href="/admin/areas/create" class="btn  btn-primary mt-3">New Area</a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('change.status', ['table' => 'areas', 'id' => $value->id]) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('deleterow', ['table' => 'areas', 'id' => $value->id, 'image' => $image]) }}"
