@section('title','Dashboard - Vendors')
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Providers List</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i
                                        class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Providers</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <input type="text" value="{{url('')}}/register/sr-vendor/vendor" class="form-control" id="myInput" disabled>
                        <button class="btn btn-primary p-2" onclick="copytext()">Copy Link</button>
                    </div>
