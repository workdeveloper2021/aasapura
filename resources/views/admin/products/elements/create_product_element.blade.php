                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0)">Add {{ $title ?? "" }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    font-weight: 700;">{{ $error }}</li>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="element_name" class="form-control" id="categoryname" placeholder="{{ $title ?? "" }}"
eholder="{{ $title ?? "" }} Name"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="element_color" class="form-control" id="categoryname" placeholder="{{ $title.' Code' ?? "" }}"
                                            aria-describedby="categorynameHelp">
