                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Help Points</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        --}}
                        <a href="/admin/help/create" class="btn  btn-primary mt-3">Add Help</a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('change.status', ['table' => 'help', 'id' => $value->id]) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('deleterow', ['table' => 'help', 'id' => $value->id, 'image' => $image]) }}"
                                            ...
                                            <a href="{{ route('help.edit', $value->id) }}"
