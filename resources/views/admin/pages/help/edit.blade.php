        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('help.update',$row->id) }}">
                             @method('put')
                            @csrf
                            <div class="row align-items-end">
                                <div class="col-12">
                                    ...
                                    <div class="p-0">
                                        <ul class="p-0 list-unstyled">
                                            ...
                                            <li style="color: rebeccapurple;color: red;font-size: 13px;font-weight: 700;">{{ $error }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    @endif
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="short_title" value="<?= $row->short_title ?>" class="form-control" id="categoryname"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="<?= $row->name ?>" class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                    </div>
                                </div>
