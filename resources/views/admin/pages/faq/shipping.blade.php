@section('title','Dashboard - Shipping Information')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        --}}
                        <a href="/admin/faq/create?type=shipping_information" class="btn  btn-primary mt-3">Add Faq</a>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->title }}</td>
                                        <td>
                                            <?php if($value->type == "order_returns"){echo "Order & Returns"; }elseif($value->type == "shipping_information"){echo "Shipping Information";}else{echo "Payments";} ?>
                                        </td>

                                        <td>
                                            <?php if ($value->status == "Y") { ?>
                                            <a href="{{ route('change.status', ['table' => 'faq', 'id' => $value->id]) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('deleterow', ['table' => 'faq', 'id' => $value->id, 'image' => $image]) }}"
