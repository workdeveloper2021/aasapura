@section('title','Dashboard - Add Team')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('teams.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="destination" class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                            @error('destination')
                                            <div class="error_text">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="col-sm-4">
                                  ...
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="about_team" row="10"></textarea>
                                        @error('about_team')
                                        <div class="error_text">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="facebook" class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                            @error('facebook')
                                        <div class="error_text">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="instagram" class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                            @error('instagram')
                                        <div class="error_text">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="twitter" class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                            @error('twitter')
                                        <div class="error_text">{{ $message }}</div>
                                        @enderror
