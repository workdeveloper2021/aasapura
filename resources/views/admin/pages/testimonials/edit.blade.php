        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('testimonials.update',$row->id) }}">
                            @csrf
                              @method('put')
                                ...
                                <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="destination" value="<?= $row->destination ?>" class="form-control" id="categoryname"
                                            aria-describedby="categorynameHelp">
                                    </div>
                                </div>
