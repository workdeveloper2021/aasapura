                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">{{ $row->name }} Subcategoris List</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i
                                        class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Subcategoris</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('change.status', ['table' => 'categories', 'id' => $value->id]) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('deleterow', ['table' => 'categories', 'id' => $value->id, 'image' => $image]) }}"
                            ...
                            {{ $categories->links('bootstrap-5-custom') }}
                        </div>
                    </div>
                </div>
            </div>
