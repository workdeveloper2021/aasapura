@section('title','Dashboard - Districts')
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">District List</h5>
                        </div>
                        <ul class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        --}}
                        <a href="/admin/districts/create/{{ $state_id }}" class="btn  btn-primary mt-3">New District</a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('change.status', ['table' => 'district', 'id' => $value->id]) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('deleterow', ['table' => 'district', 'id' => $value->id, 'image' => $image]) }}"
