            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        --}}
                        <a href="/admin/states/create" class="btn  btn-primary mt-3">New State</a>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $key+1 }}</td>
                                        <td>{{ $value->name }}</td>
                                        <td><a href="/admin/view-districts/{{ $value->id }}">View</a></td>

                                        <td>
                                            <?php if ($value->status == "Y") { ?>
                                            <a href="{{ route('change.status', ['table' => 'state', 'id' => $value->id]) }}"
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('states.edit', $value->id) }}"
