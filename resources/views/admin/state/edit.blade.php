@section('title','Dashboard - Edit State')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('states.update',$row->id) }}" method="post"
    ...
    font-weight: 700;">{{ $error }}</li>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="categoryname">State</label>
